...
const conversationSchema = new mongoose.Schema(
  {
    ...
    userProfile: {
      ...
      lastSearchFilters: {
        ...
        areaScopeLocked: { type: Boolean, default: false },
        bedrooms: { type: Number, default: null },
        ...
        typesAny: { type: Boolean, default: false },
        purpose: { type: String, default: null, trim: true },
      ...
      // Mixed avoids Mongoose cast failures on nested community-group context.
      sourceContext: { type: mongoose.Schema.Types.Mixed, default: null },
      propertySearch: {
        areas: { type: [String], default: [] },
        activeAreas: { type: [String], default: [] },
        areaScopeLocked: { type: Boolean, default: false },
        location: { type: String, default: null, trim: true },
        purpose: { type: String, default: null, trim: true },
