...
const areaGuideRoutes = require('./routes/areaGuideRoutes');
const areaGuideLeadRoutes = require('./routes/areaGuideLeadRoutes');
...
app.use('/api/area-guides', areaGuideRoutes);
app.use('/api/area-guide-leads', areaGuideLeadRoutes);
